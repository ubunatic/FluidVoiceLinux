...
- [ ] The specific `wl-copy`-spawning clipboard test (or equivalent `TextOutputDriver` subprocess test) is fixed to not inherit/hold open stdio from a resident child process, independent of the timeout work.
